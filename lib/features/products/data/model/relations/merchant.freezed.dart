...
class _$MerchantImpl implements _Merchant {
  const _$MerchantImpl(
      ...
      this.username,
      required this.image,
      @JsonKey(name: 'reviews_avg_rating') required this.reviewsAvgRating,
...
abstract class _Merchant implements Merchant {
  const factory _Merchant(
      ...
      @JsonKey(name: 'reviews_avg_rating') required final int reviewsAvgRating,
      @JsonKey(name: 'created_at')
      required final String createdAt}) = _$MerchantImpl;
